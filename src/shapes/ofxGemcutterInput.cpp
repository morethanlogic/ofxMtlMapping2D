...
//--------------------------------------------------------------
//--------------------------------------------------------------
ofxGemcutterInput::ofxGemcutterInput()
{
    disable();
}
...
//--------------------------------------------------------------
void ofxGemcutterInput::update(bool isQuad)
{
...
//--------------------------------------------------------------
void ofxGemcutterInput::calcHomography(float x0, float y0, float x1, float y1, float x2, float y2, float x3, float y3)
{
    ofPoint src[4];
    ofPoint dst[4];
    
    float vertexRadius = 15 /ofxGemcutterGlobal::inputViewZoomFactor;
    
    list<ofxGemcutterVertex*>::iterator it;
    it=vertices.begin();
    ofxGemcutterVertex* vertex = *it;
    src[0].set(vertex->x - (boundingBox.x - vertexRadius), vertex->y - (boundingBox.y - vertexRadius), 0);
    
    it++;
    vertex = *it;
    src[1].set(vertex->x - (boundingBox.x - vertexRadius), vertex->y - (boundingBox.y - vertexRadius), 0);
    
    it++;
    vertex = *it;
    src[2].set(vertex->x - (boundingBox.x - vertexRadius), vertex->y - (boundingBox.y - vertexRadius), 0);
    
    it++;
    vertex = *it;
    src[3].set(vertex->x - (boundingBox.x - vertexRadius), vertex->y - (boundingBox.y - vertexRadius), 0);
